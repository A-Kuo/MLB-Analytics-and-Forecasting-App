...
@patch("main.mlb_client.get_roster")
...
@patch("main.mlb_client.get_schedule")
...
@patch("main.mlb_client.get_game_log")
...
@patch("main.statcast_client.get_pitcher_pitches")
...
@patch("main.news_client.get_headlines")
